...
session_start();
    ...
    if (isset($_REQUEST['usr-mail'])) {
        $mail = trim(strip_tags($_REQUEST['usr-mail']));
    }
    ...
    <div class="arriba">
        ...
        <div class="login">
            ...
            <form action="login3.php" method="POST">
                <p class="txt1">
                    <b>Indique su contraseña</b>
                </p>
            
                <input class="usr-mail" type="password" name="passwd"></input>
                <input type="hidden" name="mail" value="<?php echo $mail?>"/>
                <br>
                <input class="btn-log" type="submit" value="Iniciar sesión" name="iniciar">
        ...
        <div class="registro">
                <fieldset>
                    ...
                    <a href='../registro.php'><button class="btn-reg">Crea tu cuenta en Amazen</button></a>
                </fieldset>
        </div>
